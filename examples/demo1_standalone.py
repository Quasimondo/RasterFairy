...
def main_block():
    ...
    # 5. Grid Scatter Plot
    # Note: The original notebook adjusted marker size for the grid plot (s=9)
    # and sometimes centered the plot if dimensions were not square.
    # The display_scatter_plot function now takes marker_size.
    # Centering logic can be added later if deemed necessary for visual appeal,
    # but for a direct port, plotting raw grid_xy is the first step.
    ...
    print("Output images: tsne_embedding.png, rasterfairy_grid.png")
